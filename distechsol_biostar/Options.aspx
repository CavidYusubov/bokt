<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="Options.aspx.cs" Inherits="_Default" %>
...
<dx:ASPxGridView ID="gv_Shifts" ClientInstanceName="gv_Shifts" Width="100%"
        ...
        PreviewFieldName="colID" KeyFieldName="colID" 
        onrowinserting="gv_Shifts_RowInserting" 
        onrowupdating="gv_Shifts_RowUpdating" onhtmldatacellprepared="gv_Shifts_HtmlDataCellPrepared" 
        >
    ...
    <Columns>
     <dx:GridViewCommandColumn ShowNewButtonInHeader="true" ShowEditButton="true" ShowDeleteButton="true" VisibleIndex="100" />
         <dx:GridViewDataTextColumn FieldName="colID" ReadOnly="True" Visible="false">
            ...
            <dx:GridViewDataTextColumn FieldName="colCode" VisibleIndex="2" Caption="Code">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="colColor" VisibleIndex="3" Caption = "Color" >  
            </dx:GridViewDataTextColumn>  
      ...
      <Templates>
                <DetailRow>
                    ...
                    <dx:ASPxGridView runat="server" O KeyFieldName="colID" 
                        OnCustomUnboundColumnData="gvShiftDetails_CustomUnboundColumnData" 
                        onrowupdating="gvShiftDetails_RowUpdating"  
                        OnBeforePerformDataSelect="grid2_BeforePerformDataSelect" ID="grid2" 
                        AutoGenerateColumns="False" DataSourceID="ds_shiftdetails" Width="100%">
                    <SettingsBehavior ConfirmDelete="True" />
                        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="colWDay" VisibleIndex="2" Caption="Week day" 
                                ReadOnly="true">
             <EditFormSettings Visible="False"/>
            </dx:GridViewDataTextColumn>


            <dx:GridViewDataTimeEditColumn FieldName="colTimeIn" VisibleIndex="3" Caption="Time in" 
                                UnboundType="DateTime" Visible="false">
            </dx:GridViewDataTimeEditColumn>
            <dx:GridViewDataTimeEditColumn FieldName="ubTimeIn" VisibleIndex="4" 
            Caption="Time in" UnboundType="DateTime">
                <PropertiesTimeEdit DisplayFormatString="HH:mm" EditFormat="Custom" 
            ...
            Caption="Launch in" UnboundType="DateTime">
                ...
                <EditForm>
                <table width="100%">
                <tr><td>Shift</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>Code</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>Color</td></tr>
                <tr>
                <td>
                <dx:ASPxTextBox ID="colName" runat="server" Width="100%"  Text='<%# Eval("colName") %>'></dx:ASPxTextBox>
                </td>
                <td></td>
                <td>
                <dx:ASPxTextBox ID="colCode" runat="server" Width="100%"  Text='<%# Eval("colCode") %>'></dx:ASPxTextBox>
                </td>
                <td></td>
                <td>
                <dx:ASPxColorEdit ID="colColor" runat="server"  Text='<%# Eval("colColor") %>'>  
                </dx:ASPxColorEdit>  
                </td>
...
<tr>
<td valign="top" ><b>Leaves</td>
</tr>
<tr>
<td  valign="top" >
<dx:ASPxGridView ID="gv_leaves" ClientInstanceName="gv_leaves" Width="100%"
        runat="server" AutoGenerateColumns="False" 
        DataSourceID="dsLeaves" 
        PreviewFieldName="colID" KeyFieldName="colID" 
        onhtmldatacellprepared="gv_leaves_HtmlDataCellPrepared" onrowupdating="gv_leaves_RowUpdating" 
        >
...
<dx:GridViewCommandColumn ShowEditButton="true" VisibleIndex="100" />
         ...
         <dx:GridViewDataTextColumn FieldName="colID" ReadOnly="True" Visible="false">
            ...
            <dx:GridViewDataTextColumn FieldName="colName" Caption = "Leave" 
            VisibleIndex="1"  Width="100%">
            ...
            <dx:GridViewDataTextColumn FieldName="colColor" Caption = "Color" VisibleIndex="3">
            </dx:GridViewDataTextColumn>
    ...
    <EditForm>
                <table width="100%">
                <tr><td>Code</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>Color</td></tr>
                <tr>
                <td>
                <dx:ASPxTextBox ID="colCode" runat="server" Width="100%"  Text='<%# Eval("colCode") %>'></dx:ASPxTextBox>
                </td>
    ...
    <asp:SqlDataSource ID="ds_shifts" runat="server" 
        ...
        <InsertParameters>
            <asp:Parameter Name="colName" Type="String" />
            <asp:Parameter Name="colCode" Type="String" />
            <asp:Parameter Name="colColor" Type="String" />
        </InsertParameters>
        <UpdateParameters>
            <asp:Parameter Name="colID" Type="Int32" />
            <asp:Parameter Name="colName" Type="String" />
    ...
    <asp:SqlDataSource ID="dsLeaves" runat="server" 
        ConnectionString="<%$ ConnectionStrings:timesheetConnectionString %>" 
        SelectCommand="sp_get_leavetypes" SelectCommandType="StoredProcedure" 
        UpdateCommand="sp_update_leavetypes" UpdateCommandType="StoredProcedure">
