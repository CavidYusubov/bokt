<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Site.master" inherits="_Default, App_Web_eyh02myb" %>
...
<br />
    ...
    <dx:ASPxGridView ID="mainGrid" ClientInstanceName="mainGrid" runat="server" AutoGenerateColumns="False" 
        ...
        <Settings VerticalScrollableHeight="700" VerticalScrollBarMode="Visible" 
