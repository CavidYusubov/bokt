<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="Employee.aspx.cs" Inherits="_Default" %>
...
//        alert(e.nodeKey)
    ...
    function AdjustSize() {
        ...
        gvEmployee.SetHeight(height - 200);
    }  
...
<td>
    ...
    <dx:ASPxGridView ID="gvEmployee" ClientInstanceName="gvEmployee" runat="server" AutoGenerateColumns="False" 
        ...
        <dx:GridViewCommandColumn ShowNewButtonInHeader="true" ShowEditButton="true" ShowDeleteButton="true" VisibleIndex="100" />
            ...
            <DataItemTemplate>
                ...
                ImageUrl='<%#  "data:image/jpg;base64," + Eval("colImage")  %>'>
                </dx:ASPxImage>
            </DataItemTemplate>
            </dx:GridViewDataColumn>
    ...
    <asp:SqlDataSource ID="ds_employee" runat="server" 
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="colImage" DbType="String" />
        </UpdateParameters>
    </asp:SqlDataSource>
